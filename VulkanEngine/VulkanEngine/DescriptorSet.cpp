...
namespace HN
{
	...
	DescriptorSetLayout::DescriptorSetLayout(Device& HDevice, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings) : device{ HDevice }, bindings{ bindings }
	{
	...
	DescriptorPool::DescriptorPool(Device& HDevice, uint32_t maxSets, VkDescriptorPoolCreateFlags poolFlags, const std::vector<VkDescriptorPoolSize>& poolSizes) : device{ HDevice }
	{
